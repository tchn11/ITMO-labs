...
const GraphSvg = (props) => {
    return(
        <svg width="220" height="220" className="svg-graph" xmlns="http://www.w3.org/2000/svg">
            ...
            <text className="coordinate-text coordinate-text_minus-half-Rx" x="66" y="100" font-size="14">-R/2</text>
            ...
            <text className="coordinate-text coordinate-text_minus-half-Ry" x="120" y="148" font-size="14">-R/2</text>
            ...
            <polygon className="svg-figure triangle-figure" points="43,110 110,110 110,76"
                     fill="blue" fill-opacity="0.25" stroke="darkblue" stroke-opacity="0.5"/>

            <polygon className="svg-figure rectangle-figure" points="43,143 110,143 110,110 43,110"
                     fill="yellow" fill-opacity="0.25" stroke="#CCCC00" stroke-opacity="0.5"/>

            <path className="svg-figure circle-figure" d="M 111 143 A 30 30 0 0 0 143 110 L 110 110 Z"
